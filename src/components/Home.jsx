...
const Home = () => {
  ...
  return (
    <section className={`relative w-full mx-auto`}>
      <div className='w-full  lg:pt-0  mx-auto md:grid md:grid-cols-2  z-0 flex items-center flex-col-reverse'>
        <div className='flex flex-col justify-center md:mt-5 mt-4'>
